<div class="jumbotron">
    <h1>Pharket</h1>      
    <p>
        This is an open-source project by <a href="http://pablosantamaria.com" target="_new">Pablo Santamaría</a>
        to test <a href="https://phalconphp.com" target="_new">Phalcon</a>. 
    ...
    <p>
        ...
        <br>
        Please select any of them to start "investing".
    </p>
</div>